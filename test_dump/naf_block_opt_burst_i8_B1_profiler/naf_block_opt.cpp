                           ...
                           (Qnn_Tensor_t) {
                               ...
                               {.v2= {
                                 ...
                                 .quantizeParams= { QNN_DEFINITION_DEFINED,
                                                    ...
                                                    {.scaleOffsetEncoding= {.scale= 1994501647358467574230514437351014400.0000000000000000f, .offset= -170}}},
                                 .rank= 4,
  ...
  Qnn_Tensor_t outputs_Conv_0[] = {
    (Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_DEFINED,
                               QNN_QUANTIZATION_ENCODING_SCALE_OFFSET,
                               {.scaleOffsetEncoding= {.scale= 844963441068553276046215430608519168.0000000000000000f, .offset= -119}}},
            .rank= 4,
  ...
  Qnn_Tensor_t outputs_Conv_5[] = {
    (Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_DEFINED,
                               QNN_QUANTIZATION_ENCODING_SCALE_OFFSET,
                               {.scaleOffsetEncoding= {.scale= 0.0204337816685438f, .offset= -132}}},
            .rank= 4,
  ...
  Qnn_Tensor_t outputs_Conv_6[] = {
    (Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_DEFINED,
                               QNN_QUANTIZATION_ENCODING_SCALE_OFFSET,
                               {.scaleOffsetEncoding= {.scale= 0.0164499413222075f, .offset= -132}}},
            .rank= 4,
  ...
  Qnn_Tensor_t outputs_Mul_17[] = {
    (Qnn_Tensor_t) {
          ...
          {.v2= {
            ...
            .quantizeParams= { QNN_DEFINITION_DEFINED,
                               QNN_QUANTIZATION_ENCODING_SCALE_OFFSET,
                               {.scaleOffsetEncoding= {.scale= 0.0147727821022272f, .offset= -138}}},
            .rank= 4,
...
static ModelError_t addNode_Conv_21(QnnModel& model){
  ...
  uint32_t dimensions__48[] = {1, 1, 1, 32};
...
static ModelError_t addNode_Add_23(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR Add_23 */
  Qnn_Param_t params_Add_23[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 0}}}}
  };
  const char*  inputs_Add_23[] = {
    "_23",
    "_48"
  };
  uint32_t dimensions__50[] = {1, 512, 512, 32};
  Qnn_Tensor_t outputs_Add_23[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         ...
                         "qti.aisw", // Package Name
                         "ElementWiseBinary", // Qnn Node Type
                         params_Add_23, // Node Params
                         1, // Num Node Params
                         inputs_Add_23, // Input Tensor Names
                         2, // Num Input Tensor Names
                         outputs_Add_23, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
static ModelError_t addNode_Add_42(QnnModel& model){
  ModelError_t err = MODEL_NO_ERROR;

  /* ADDING NODE FOR Add_42 */
  Qnn_Param_t params_Add_42[] = {
    {.paramType=QNN_PARAMTYPE_SCALAR,
     .name="operation",
     {.scalarParam= (Qnn_Scalar_t) {QNN_DATATYPE_UINT_32, {.uint32Value = 0}}}}
  };
  const char*  inputs_Add_42[] = {
    "_50",
    "_71"
  };
  uint32_t dimensions__73[] = {1, 512, 512, 32};
  Qnn_Tensor_t outputs_Add_42[] = {
    (Qnn_Tensor_t) {
          .version= QNN_TENSOR_VERSION_2,
          {.v2= {
            .id=0,
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1, // Op_Config_t Version
                         ...
                         "qti.aisw", // Package Name
                         "ElementWiseBinary", // Qnn Node Type
                         params_Add_42, // Node Params
                         1, // Num Node Params
                         inputs_Add_42, // Input Tensor Names
                         2, // Num Input Tensor Names
                         outputs_Add_42, // Output Tensors 
                         1// Num Output Tensors 
  ), err);
  return err;
}
...
ModelError_t QnnModel_composeGraphs(Qnn_BackendHandle_t backendHandle,
  ...
  /* model/graph for naf_block_opt*/
  QnnModel naf_block_opt;
  const QnnGraph_Config_t** graphConfigs = nullptr;
  VALIDATE(getQnnGraphConfigFromInfo("naf_block_opt", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(naf_block_opt.initialize(backendHandle, interface, contextHandle, "naf_block_opt", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  VALIDATE(addTensor_input_1(naf_block_opt), err);
  VALIDATE(addTensor_conv0_weight(naf_block_opt), err);
  VALIDATE(addTensor_conv0_bias(naf_block_opt), err);
  VALIDATE(addNode_Conv_0(naf_block_opt), err);
  VALIDATE(addNode_Tanh_2(naf_block_opt), err);
  VALIDATE(addTensor_conv1_weight(naf_block_opt), err);
  VALIDATE(addTensor_conv1_bias(naf_block_opt), err);
  VALIDATE(addNode_Conv_5(naf_block_opt), err);
  VALIDATE(addTensor_conv2_weight(naf_block_opt), err);
  VALIDATE(addTensor_conv2_bias(naf_block_opt), err);
  VALIDATE(addNode_Conv_6(naf_block_opt), err);
  VALIDATE(addNode_Slice_11(naf_block_opt), err);
  VALIDATE(addNode_Slice_16(naf_block_opt), err);
  VALIDATE(addNode_Mul_17(naf_block_opt), err);
  VALIDATE(addNode_GlobalAveragePool_18(naf_block_opt), err);
  VALIDATE(addTensor_sca_1_weight(naf_block_opt), err);
  VALIDATE(addTensor_sca_1_bias(naf_block_opt), err);
  VALIDATE(addNode_Conv_19(naf_block_opt), err);
  VALIDATE(addTensor_conv3_weight(naf_block_opt), err);
  VALIDATE(addTensor_conv3_bias(naf_block_opt), err);
  VALIDATE(addNode_Conv_21(naf_block_opt), err);
  VALIDATE(addNode_Add_23(naf_block_opt), err);
  VALIDATE(addNode_Tanh_25(naf_block_opt), err);
  VALIDATE(addTensor_conv4_weight(naf_block_opt), err);
  VALIDATE(addTensor_conv4_bias(naf_block_opt), err);
  VALIDATE(addNode_Conv_28(naf_block_opt), err);
  VALIDATE(addNode_Slice_33(naf_block_opt), err);
  VALIDATE(addNode_Slice_38(naf_block_opt), err);
  VALIDATE(addNode_Mul_39(naf_block_opt), err);
  VALIDATE(addTensor_conv5_weight(naf_block_opt), err);
  VALIDATE(addTensor_conv5_bias(naf_block_opt), err);
  VALIDATE(addNode_Conv_40(naf_block_opt), err);
  VALIDATE(addNode_Add_42(naf_block_opt), err);

  // Add all models to array to get graphsInfo
  QnnModel* models [] = {&naf_block_opt};
